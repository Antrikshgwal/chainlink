...
func TestFastTransferUpdateLaneConfigChangeset_ValidationErrors(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			_, err := v1_5_1.FastTransferUpdateLaneConfigChangeset(e, config)
			require.Error(t, err)
...
func TestFastTransferFillerAllowlistChangeset_ValidationErrors(t *testing.T) {
	...
	t.Run("Empty_FillerUpdates", func(t *testing.T) {
		...
		_, err := v1_5_1.FastTransferUpdateFillerAllowlist(e, config)
		require.Error(t, err)
...
func TestFastTransferFillerAllowlistChangeset_RemoveFillers(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			_, err := v1_5_1.FastTransferUpdateFillerAllowlist(e, addConfig)
			...
			_, err = v1_5_1.FastTransferUpdateFillerAllowlist(e, removeConfig)
			require.NoError(t, err)
...
func TestFastTransferFillerAllowlistChangeset_AddAndRemoveSimultaneously(t *testing.T) {
	...
	for _, tc := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			_, err := v1_5_1.FastTransferUpdateFillerAllowlist(e, updateConfig)
			require.NoError(t, err)
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.mcmsEnabled {
				_, _, err := commonchangeset.ApplyChangesets(t, e, []commonchangeset.ConfiguredChangeSet{
					commonchangeset.Configure(cldf.CreateLegacyChangeSet(v1_5_1.FastTransferUpdateLaneConfigChangeset), config),
				})
				require.NoError(t, err)
			} else {
				_, err := v1_5_1.FastTransferUpdateLaneConfigChangeset(e, config)
...
func TestFastTransferFillerAllowlistChangeset_WithMCMS(t *testing.T) {
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.mcmsEnabled {
				_, _, err := commonchangeset.ApplyChangesets(t, e, []commonchangeset.ConfiguredChangeSet{
					commonchangeset.Configure(cldf.CreateLegacyChangeSet(v1_5_1.FastTransferUpdateFillerAllowlist), config),
				})
				require.NoError(t, err)
			} else {
				_, err := v1_5_1.FastTransferUpdateFillerAllowlist(e, config)
			...
			pool := state.Chains[selectorA].BurnMintFastTransferTokenPools[testhelpers.TestTokenSymbol][shared.FastTransferTokenPoolVersion]
			destinationPool := state.Chains[selectorB].BurnMintFastTransferTokenPools[testhelpers.TestTokenSymbol][shared.FastTransferTokenPoolVersion]
	...
	testCases := []testCase{
		{
			...
			update: v1_5_1.UpdateLaneConfig{
				FastTransferFillerFeeBps: 10000,
...
func TestFastTransferFillerAllowlistChangeset_DuplicateFillerValidation(t *testing.T) {
	...
	_, err = v1_5_1.FastTransferUpdateFillerAllowlist(e, duplicateConfig)
	require.Error(t, err)
