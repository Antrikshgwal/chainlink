...
var (
	E2E_FAST_FILLER_IMAGE     = "E2E_FAST_FILLER_IMAGE"
	DEFAULT_FAST_FILLER_IMAGE = "ccip-fast-filler:latest"
)
...
func (f *CCIPFastFiller) Start(ctx context.Context, t *testing.T) error {
	...
	image := DEFAULT_FAST_FILLER_IMAGE
	if envImage := os.Getenv(E2E_FAST_FILLER_IMAGE); envImage != "" {
		image = envImage
	}
